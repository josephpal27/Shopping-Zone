...
<head>
    ...
    <title>Shopping Zone - Search Results</title>
...
<body>
    ...
    <!-- Hero Section Starts Here -->
      <section>
         <div class="container-xxl my-container">
            <!-- Left Side -->
            <aside>
                <div class="filter">
                    <h5>Filters</h5>
                ...
                <div class="filter">
                    ...
                    <div class="filter-options">
                        <div>
                            <input type="checkbox" name="checkbox"> <span>Low to High</span>
                        </div>
                        <div>
                            <input type="checkbox" name="checkbox"> <span>High to Low</span>
                        </div>
                    </div>
                </div>
